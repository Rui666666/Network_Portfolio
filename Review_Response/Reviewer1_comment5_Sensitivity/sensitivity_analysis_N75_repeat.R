...
p = 75
num_sampling = 100
l2_norm_reletive_error_2constraint.list = c()
l2_norm_reletive_error_3constraint.list = c()
for (i_sample in 1:num_sampling) {
  ...
  l2_norm_reletive_error_2constraint.list[i_sample] = relative_error(w_network_2constraint_plugin, w_2constraint_dantzig)
  l2_norm_reletive_error_3constraint.list[i_sample] = relative_error(w_network_3constraint_plugin, w_3constraint_dantzig)
}

l2_norm_reletive_error_2constraint = mean(l2_norm_reletive_error_2constraint.list)
l2_norm_reletive_error_3constraint = mean(l2_norm_reletive_error_3constraint.list)
...
# L2 norm reletive error for 2-constraint portfolios: 0.136901 
# L2 norm reletive error for 3-constraint portfolios: 0.1761375 
